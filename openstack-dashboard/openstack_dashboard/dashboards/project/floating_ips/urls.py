...
urlpatterns = [
    ...
    url(r'^forwarding/$', views.ForwardingView.as_view(), name='forwarding'),
    url(r'^delete_port_forwarding/(?P<ip_id>[^/]+)/$',views.DeleteForwardingView.as_view(), name='delete_port_forwarding'),
]
